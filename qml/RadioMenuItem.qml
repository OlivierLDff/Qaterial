...
Qaterial.MenuItem
{
    ...
    Qaterial.ColorIcon
    {
        ...
        color: control.enabled ? (control.colorReversed ? Qaterial.Style.primaryTextColorReversed() : Qaterial.Style.primaryTextColor()) : (control.colorReversed ? Qaterial.Style.hintTextColorReversed() : Qaterial.Style.hintTextColor())
    }
}
