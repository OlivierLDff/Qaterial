...
Qaterial.Popup
{
  ...
  enter: Transition
  {
    NumberAnimation { property: "scale"; from: 0.0; to: 1.0; easing.type: Easing.OutQuint; duration: 220 } // NumberAnimation
    NumberAnimation { property: "opacity"; from: 0.0; to: 1.0; easing.type: Easing.OutCubic; duration: 150 } // NumberAnimation
  } // Transition

  exit: Transition
  {
    NumberAnimation { property: "scale"; from: 1.0; to: 0.0; easing.type: Easing.OutQuint; duration: 220 } // NumberAnimation
