...
Qaterial.FabButton
{
  ...
  foregroundColor: !enabled ? Qaterial.Style.disabledTextColor() :
      highlighted ? (Qaterial.Style.shouldReverseForegroundOnAccent ? Qaterial.Style.primaryTextColorReversed() : Qaterial.Style.primaryTextColor()) :
      Qaterial.Style.theme === Qaterial.Style.Theme.Light ? Qaterial.Style.primaryTextColor() : Qaterial.Style.secondaryTextColor()
  enabledScale: false
