...
Qaterial.GradientSlider
{
  ...
  gradient: Gradient
  {
    ...
    {
      position: 1.000
      color: control.hsv ? Qt.hsva(control.color.hsvHue, control.color.hsvSaturation, 1, control.color.a) :
                           Qt.hsla(control.color.hslHue, control.color.hslSaturation, 1, control.color.a)
    }
  }
} // Slider
