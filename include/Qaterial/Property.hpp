...
#define QATERIAL_ABSTRACT_PROPERTY(type, attribute, Attribute)                                                         \
    QATERIAL_ABSTRACT_PROPERTY_D(type, attribute, Attribute, {})
...
#define QATERIAL_ABSTRACT_PROPERTY_RO(type, attribute, Attribute)                                                      \
    QATERIAL_ABSTRACT_PROPERTY_RO_D(type, attribute, Attribute, {})
...
public:                                                                                                                \
    static void registerToQml(                                                                                         \
        const char* uri = "Qaterial", const int majorVersion = 1, const int minorVersion = 0, const char* name = #Type)\
    {                                                                                                                  \
